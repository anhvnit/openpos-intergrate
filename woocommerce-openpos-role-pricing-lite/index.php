<?php
/*
Plugin Name: Woocommerce - Openpos -  Woocommerce Role Pricing Lite
...
Text Domain: woocommerce-role-pricing-lite
...
if(!function_exists('WooRolePricingLite_op_customer_data'))
{
    function WooRolePricingLite_op_customer_data($customer_data){
        global $current_user;
        global $op_woo;
...
add_filter('op_customer_data','WooRolePricingLite_op_customer_data',10,1);
