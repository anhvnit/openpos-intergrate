<?php
	...
	class Star_CloudPRNT_Printer_Handler
	{
		...
		{
			// Sanitize
			$sanitized_mac = isset($_GET['mac']) ? self::sanitize_parameter($_GET['mac']) : '';
...
//start debug
$fp = fopen(STAR_CLOUDPRNT_DATA_FOLDER_PATH.'/debug.txt', 'a+');
...
//end debug
	...
	else if ($_SERVER['REQUEST_METHOD'] == 'GET')
	{
        ...
        {
            $printer_handler->handle_delete();
        }else
        {
            $printer_handler->handle_get();
        }
	}
