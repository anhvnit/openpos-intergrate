<?php
	...
	function star_cloudprnt_get_plugin_root()
	{
		...
		if (defined( 'ABSPATH' ))
		{
			...
			if (basename($plugin_dir) === 'woocommerce-openpos-start-cloudprnt') $plugin_dir = star_cloudprnt_get_previous_dir_path($plugin_dir, 3);
	...
	define('STAR_CLOUDPRNT_DATA_FOLDER_PATH',dirname(__DIR__). '/data');
	define('STAR_CLOUDPRNT_PRINTER_DATA_SAVE_PATH', STAR_CLOUDPRNT_DATA_FOLDER_PATH.'/printerdata');
	define('STAR_CLOUDPRNT_PRINTER_PENDING_SAVE_PATH', STAR_CLOUDPRNT_DATA_FOLDER_PATH.'/pending');
